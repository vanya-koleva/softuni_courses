...
class Project(models.Model):
    ...
    def get_programmers_with_technologies(self) -> QuerySet:
        """
        1. Get programmers working on this project → self.programmers
        2. Look at the projects those programmers are working on → projects
        3. Fetch technologies used in those projects → technologies_used
           Fetch technologies through projects -> __
        Programmer → Projects → Technologies Used
        When fetching programmers, also prefetch their related projects.
        Then, for those projects, also prefetch their technologies.
        """
